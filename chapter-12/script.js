// Sets the number of times the game repeats
// Currently a random number between 2 & 5
let numTreasures = Math.floor(Math.random() * 4) + 2;
// Game intro
let text = "You're on a deserted island, looking for " + numTreasures + " treasure. ";
...
// Convert game to a large function to allow for repeating
function playGame() {
  // Treasure Generator
